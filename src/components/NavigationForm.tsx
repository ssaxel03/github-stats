...
export default function NavigationForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-row items-center justify-center gap-2">
            ...
            <button type="submit" className="h-[36px] aspect-square flex items-center justify-center dark:bg-second-dark bg-second-light dark:hover:bg-third-dark hover:bg-light px-1 py-1 rounded-md border-b-2 border-r-2 border-solid dark:border-third-dark border-dark">
