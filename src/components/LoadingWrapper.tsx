...
export default function Loading({
    ...
    return (
        <>
            <div hidden={loaded >= 4} className="min-h-[100svh] flex flex-col gap-4 items-center justify-center w-full max-w-[800px] px-6">
                Loading... [{loaded}/4]
            ...
            <div hidden={!(loaded >= 4)} className="flex flex-col justify-center items-center w-full max-w-[800px] py-16 px-6">
